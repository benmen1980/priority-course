...
<div class="my-accordion">
    ...
    <div class="title-flex">
        <img class="roi-diploma" src="<?php echo plugins_url('my-course-priority/includes/img/roi-one.jpg')?>" aria-hidden="false" alt="">
        ...
        <p class="course-description">
            ...
            הקורס כולל הסברים, דוגמאות ותרגילים, לכל כליי הפיתוח העיקריים בפריוריטי.<br>
            הקורס עובד בצמוד ל SDK צעד אחרי צעד.<br>
            הקורס מתאים לבעלי רקע יישומי בפריוריטי אשר רכשו רקע בסיסי בבסיסיי נתונים ו SQL.  <br>
        </p>
    </div>
        <img class="roi-diploma" src="<?php echo plugins_url('my-course-priority/includes/img/roi-two.jpg')?>" aria-hidden="false" alt="">
...
//get all the lessons
    ...
    <div class="list-lessons">
        ...
        <div>
            <p class="helo-note"><?php echo $user_firstname; ?> שלום וברכה.  הנך מצורפ/ת ל<?php echo $maslul_name; ?> , הקורס זמין עבורך עד לתאריך <?php echo $formatted_date; ?>.</p>
        </div>
        <?php } ?>
...
<!--                            <div class="summary">--><?php //echo $summary; ?><!-- </div>-->
                            <div class="buttons-tabs-textarea">
                                <button id="summary" class="summary active">תקציר:</button>
                                <button id="exercises" class="exercises">תרגילים:</button>
                                <button id="solution" class="solution">פתרונות:</button>
                                <?php if($more_notes){ ?>
                                    <button id="more_notes" class="more_notes">הרחבה:</button>
                                <?php } ?>

                            </div>
                            <div class="exercises textarea-tab" >
                                <p><?php echo  $exercises ?>
                                </p>
                            </div>
                            <div class="solution textarea-tab" >
                                <p><?php echo  $solution ?>
                                </p>
                            </div>
                            <div class="more_notes textarea-tab" >
                                <p><?php echo  $more_notes ?>
                                </p>
                            </div>
                            <div class="summary textarea-tab">
                                <?php echo $summary; ?>
                            </div>
                            <div class="col-3">
<!--                               <p>נשמח לשיתוף הפיתרון שלכם!</p>-->
                                <div class="button-to-comment button-animation" target="_blank"> לתגובות ושאלות על השיעור </div>
                                <img class="arrow-left" src="<?php echo plugins_url('my-course-priority/includes/img/copywriting.gif')?>" aria-hidden="false" alt="">
                            </div>
                        </div>
                    </div>
    ...
    <div class="show">
        ...
        <div class="img-show">
            ...
            <div>
                ...
                <a target="_blank" href="<?php echo  get_site_url() ?>/shop-course">מסלולים להרשמה
